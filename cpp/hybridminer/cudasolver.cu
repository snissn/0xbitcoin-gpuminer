...
/*
  ...
  printf( "\n/prefix\n" );
*/
  unsigned char * s_solution;
  CUDASolver::bytes_t byte_solution( CUDASolver::UINT256_LENGTH );
  ...
  do
  {
    ...
    s_solution = find_message( target_input, hash_prefix );
